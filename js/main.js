const Main = {
    ...
    buildTasks: function(){
        ...
        this.tasks.forEach (item=>{
            html += this.gestTaskHtml(item.task)
        })
    ...
    Events: {
        ...
        inputTask_keypress: function(e){
            ...
            if (key === 'Enter'){
                this.$list.innerHTML += this.gestTaskHtml(value)
        ...
        removeButton_click: function(e){
         ...
         locoalStorage.setItem('tasks', JSON.stringify(newTasksState))
